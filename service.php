  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <a href="ajout_service.php" class='btn btn-primary btn-sm'>Ajouter Service</a>
        <h2>SERVICE</h2>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        $sql = "SELECT id, titre, image FROM service";
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<a href='modif_service.php?id=" . $row["id"] . "' class='btn btn-primary btn-sm'>Modifier</a>";
                echo "<a href='supprimer_service.php?id=" . $row["id"] . "' class='btn btn-danger btn-sm ml-2'>Supprimer</a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
