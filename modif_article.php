...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="mb-3">
        <label for="titre" class="form-label">Nouveau titre de l'article</label>
        <input type="text" class="form-control" id="titre" name="titre" required>
    </div>
    <div class="mb-3">
        <label for="image" class="form-label">Nouvelle image du l'article</label>
        <input type="file" class="form-control" id="image" name="image" accept="image/*">
    </div>
    <div class="mb-3">
        <label for="titre" class="form-label">Nouveau description l'article</label>
        <input type="text" class="form-control" id="titre" name="titre" required>
    </div>
...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['article_id']) && !empty($_POST['article_id']) && isset($_POST['titre'])) {
            ...
            $sql = "UPDATE article SET titre = :nouveauTitre WHERE id = :articleId";
            ...
            echo "Données manquantes pour la mise à jour de l'article.";
        }
    }
