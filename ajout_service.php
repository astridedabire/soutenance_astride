  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <form action="traitement_service.php" method="POST" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <button type="submit" name="submit" class="btn btn-primary">Ajouter le service</button>
</form>
