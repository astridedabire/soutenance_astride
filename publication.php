...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
    ...
    <form action="traitement-pub.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label for="titre1">Titre 1 :</label>
            <input type="text" class="form-control" id="titre1" name="titre1">
        </div>
        <div class="form-group">
            <label for="titre2">Titre 2 :</label>
            <input type="text" class="form-control" id="titre2" name="titre2">
        </div>
        <div class="form-group">
