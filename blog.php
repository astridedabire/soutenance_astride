            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-100 mb-4" src="logo.png" alt="Image">
                        ...
                        <img class="img-fluid rounded w-50 float-left mr-4 mb-3" src="groupe2.jpg" alt="Image">
                    ...
                    <div class="bg-secondary rounded p-5">
                        <h3 class="text-uppercase mb-4" style="letter-spacing: 5px;">Faite un commentaire</h3>
                        <form action="traitement_commentaire.php" method="post">
                            <div class="form-group">
                                <label for="name">NOM</label>
                                <input type="text" class="form-control border-0" name="nom" id="name">
                            </div>
                            <div class="form-group">
