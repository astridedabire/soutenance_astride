  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <a href="ajout_article.php" class='btn btn-primary btn-sm'>Ajouter article</a>
        <h2>Article</h2>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        $sql = "SELECT id, titre, image, description FROM article";
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td><img src='uploads/" . $row["image"] . "' alt='Service Image' style='max-width: 100px;'></td>";
                echo "<td>" . $row["description"] . "</td>";
                echo "<td>";
                echo "<a href='modif_article.php?id=" . $row["id"] . "' class='btn btn-primary btn-sm'>Modifier</a>";
                echo "<a href='supprimer_article.php?id=" . $row["id"] . "' class='btn btn-danger btn-sm ml-2'>Supprimer</a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
